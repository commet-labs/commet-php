...
final class WebhookEvent
{
    ...
    public function asSubscriptionReactivated(): SubscriptionReactivatedData
    {
    ...
    public function asPaymentRetryFailed(): PaymentRetryFailedData
    {
        return PaymentRetryFailedData::fromArray($this->data);
    }
    ...
    public function asPaymentLinkCreated(): PaymentLinkCreatedData
    {
        return PaymentLinkCreatedData::fromArray($this->data);
    }

    public function asPaymentLinkCompleted(): PaymentLinkCompletedData
    {
        return PaymentLinkCompletedData::fromArray($this->data);
    }

    public function asPaymentLinkFailed(): PaymentLinkFailedData
    {
        return PaymentLinkFailedData::fromArray($this->data);
    }

    public function asPaymentLinkCanceled(): PaymentLinkCanceledData
    {
        return PaymentLinkCanceledData::fromArray($this->data);
    }
